...
- (id)init
{
    if (self = [super init]) {
        ...
        self.dateFormatter.dateFormat =
                [NSDateFormatter dateFormatFromTemplate:@"d MMMM yyyy" options:0 locale:[NSLocale currentLocale]];
    }
    return self;
}
...
- (ABCalendarPickerAnimation)animationForZoomOutToProvider:(id <ABCalendarPickerDateProviderProtocol>)provider
{
    NSInteger weekNumber =
            [self.calendar ordinalityOfUnit:NSWeekCalendarUnit inUnit:NSMonthCalendarUnit forDate:[self.dateOwner highlightedDate]];
             ...
             andColumn:(NSInteger)column
{
    ...
    NSInteger highlightedDay =
            [self.calendar ordinalityOfUnit:NSDayCalendarUnit inUnit:NSWeekCalendarUnit forDate:[self.dateOwner highlightedDate]];
    NSInteger highlightedWeekday =
            [self.calendar ordinalityOfUnit:NSWeekdayCalendarUnit inUnit:NSWeekCalendarUnit forDate:[self.dateOwner highlightedDate]];
