...
{
    if (_winterLabel == nil)
        _winterLabel = [@"ru" isEqualToString:[NSLocale preferredLanguages][0]] ? @"Зима" : @"Winter";
    return _winterLabel;
}
...
{
    if (_springLabel == nil)
        _springLabel = [@"ru" isEqualToString:[NSLocale preferredLanguages][0]] ? @"Весна" : @"Spring";
    return _springLabel;
}
...
{
    if (_summerLabel == nil)
        _summerLabel = [@"ru" isEqualToString:[NSLocale preferredLanguages][0]] ? @"Лето" : @"Summer";
    return _summerLabel;
}
...
{
    if (_autumnLabel == nil)
        _autumnLabel = [@"ru" isEqualToString:[NSLocale preferredLanguages][0]] ? @"Осень" : @"Autumn";
    return _autumnLabel;
}
...
{
    NSArray *array =
            @[self.winterLabel, self.springLabel, self.summerLabel, self.autumnLabel, self.winterLabel];
    return array[column];
}
